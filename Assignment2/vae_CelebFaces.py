...
# # Q(z|X) -- encoder
# inputImg = Input(shape=(imRows, imCols, imChs))  # adapt this if using `channels_first` image data format
# x = Conv2D(64, (3, 3), strides=(1, 1), padding='same', activation='relu')(inputImg)     #218x178x64
# x = Conv2D(64, (3, 3), strides=(1, 1), padding='valid', activation='relu')(x)    #216x176x64
# x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same')(x)           #108x88x64
# x = Conv2D(128, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #108x88x128
# x = Conv2D(128, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #108x88x128
# x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same')(x)           #54x44x128
# x = Conv2D(256, (3, 3), strides=(1, 1), padding='valid', activation='relu')(x)  #52x42x256
# x = Conv2D(256, (3, 3), strides=(1, 1), padding='valid', activation='relu')(x)  #50x40x256
# x = Conv2D(256, (3, 3), strides=(1, 1), padding='valid', activation='relu')(x)  #48x38x256
# x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same')(x)           #24x19x256
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #27x23x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #27x23x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #27x23x512
# x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same')(x)           #14x12x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #14x12x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #14x12x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #14x12x512
# x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same')(x)           #7x6x512
# x = Flatten()(x)                                                                #21504
# x = Dense(4096, activation='relu')(x)                                           #4096
# x = Dense(4096, activation='relu')(x)                                           #4096
# x = Dense(2622, activation='relu')(x)                                           #2622
...
# # VGG Face
# # P(X|z) -- decoder
# x = Dense(2622, activation='relu', input_shape=(zDims,))(z)                     #2622
# x = Dense(4096, activation='relu')(x)                                           #4096
# x = Dense(4096, activation='relu')(x)                                           #4096
# x = Dense(21504, activation='relu')(x)                                          #21504
# x = Reshape((7, 6, 512))(x)                                                     #7x6x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #7x6x512
# x = UpSampling2D(size=(2, 2))(x)                                                #14x12x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #14x12x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #14x12x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #14x12x512
# x = UpSampling2D(size=(2, 2))(x)                                                #28x24x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #28x24x512
# x = Conv2D(512, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #28x24x512
# x = Conv2D(256, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #28x23x256
# x = UpSampling2D(size=(2, 2))(x)                                                #56x46x256
# x = Conv2D(256, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #56x46x256
# x = Conv2D(256, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #56x46x256
# x = Conv2D(128, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)   #57x46x128
# x = UpSampling2D(size=(2, 2))(x)                                                #114x94x128
# x = Conv2D(128, (3, 3), strides=(1, 1), padding='valid', activation='relu')(x)  #112x92x128
# x = Conv2D(64, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)    #110x90x64
# x = UpSampling2D(size=(2, 2))(x)                                                #220x180x64
# x = Conv2D(64, (3, 3), strides=(1, 1), padding='same', activation='relu')(x)    #220x180x64
# decodedImg = Conv2D(3, (3, 3), strides=(1, 1), padding='valid', activation='relu')(x)   #218x178x3
